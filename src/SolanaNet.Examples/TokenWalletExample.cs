using SolanaNet.Extensions;
using SolanaNet.Extensions.TokenMint;
using SolanaNet.Rpc;
using System;
...
namespace SolanaNet.Examples
{
    public class TokenWalletExample : IExample
    {
        ...
        public void Run()
        {
            ...
            // add TokenDef for a TestNet minted token created by SolanaNet examples
            var tokens = new TokenMintResolver();
            tokens.Add(new TokenDef("AHRNasvVB8UDkU9knqPcn4aVfRbnbVC9HJgSTBwbx8re", "SolanaNet Test Token", "STT", 2));
